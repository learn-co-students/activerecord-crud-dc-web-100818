...
def can_find_using_where_clause_and_be_sorted
  ...
  later_movies = Movie.where("release_date > 2002")
  later_movies.sort_by{|movie| movie.release_date}.reverse
end

def can_be_found_updated_and_saved
  # Updtate the title "Awesome Flick" to "Even Awesomer Flick", save it, then return it
  Movie.create(title: "Awesome Flick")
  change_movie = Movie.find_by(title: "Awesome Flick")
  change_movie.title = "Even Awesomer Flick"
  change_movie.save
  change_movie
end
